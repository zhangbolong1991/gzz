				  ...
				  @if(session('error'))
            	   ...
            	   @if (count($errors) > 0)
					...
					<form action="/forget" method="post">
            		  ...
            		  <div class="col-md-12">
					 <a href="/encrypted"><button class="btn btn-success">密保找回</button></a>
					 <a href="/forget"><button class="btn btn-success">邮箱找回</button></a>
					 <div>
					  <span id="span"></span>
					 </div>
					  </div>
					  ...
					  <div class="form-group"> 
            		  <div class="col-md-12">						
					  <input type="email" name="email" placeholder="输入您的注册邮箱" required=" ">
					  </div>
					  </div>
