		...
		<div class="w3_login">
			...
			<div class="w3_login_module">
				<div class="module form-module">
				  ...
				  <div class="cta" style="margin-top:30px"><a href="#">忘记密码?</a></div>
				  ...
				  @if(session('error'))
            	   ...
            	   @if (count($errors) > 0)
					...
					<div class="tooltip"><h5>点击登陆</h5></div>
            		  ...
            		  <div class="col-md-12">
					  <input type="text" name="username" placeholder="账户:5-11位任意字母、数字、下划线" required=" ">
					  </div>
					  </div>
					 
					  <div class="form-group"> 
            		  <div class="col-md-12">
					  <input type="password" name="password" placeholder="密码：6-11位数字、字母、下划线" required=" ">
					  </div>
					  </div>
