     ...
     <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info"> 
      <thead> 
       <tr role="row">
        ...
        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 172px;" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">订单号</th>
      ...
      <tbody role="alert" aria-live="polite" aria-relevant="all">
       ...
       <tr class="odd"> 
        ...
        <td class=" "><a href="/admin/order/detail/{{$row['oid']}}" class="btn btn-success small"><i class='icon-eye-open'></i></a><a href="/admin/order/edit/{{$row['oid']}}" class="btn btn-info small"><i class="icon-pencil"></i></a> </td> 
       </tr>
       	@endforeach
      </tbody>
     </table>
