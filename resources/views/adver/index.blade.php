     ...
     <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info"> 
      ...
      <tbody role="alert" aria-live="polite" aria-relevant="all">
       ...
       <tr class="odd"> 
        ...
        <td class=" "><img src="/uploads/{{$row['picname']}}" width="100px"></td> 
        <td class=" ">{{$row['url']}}</td> 
        <td class=" ">
        @if($row['status']=='1')
        	启用
        ...
        <td class=" "><a href="/admin/adver/del/{{$row['id']}}" class="btn btn-success">删除</a> <a href="/admin/adver/edit/{{$row['id']}}" class="btn btn-info">修改</a></td> 
       </tr>
       	@endforeach
      </tbody>
     </table>
