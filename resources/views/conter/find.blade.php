...
@section('right')
<div class="container" style="position:absolute; top:250px; left:300px;">
				...
				<div class="module form-module">
				  ...
				  @if(session('error'))
            	   ...
            	   @if (count($errors) > 0)
					...
					@endif
					<h4>设置密保</h4>
					<form action="/guarb" method="post">
					
				  </div>
					  <div class="form-group"> 
            		  <div class="col-md-12">
					  <select name="issue" id="" class="form-control" style="align:conter">
					 ...
					 <div>
					  ...
					  <div class="form-group"> 
            		  <div class="col-md-12">						
					  <input type="text" name="answer" placeholder="设置答案" required=" ">
					  </div>
					  </div>
